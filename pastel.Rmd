---
title: "**Gráfico de Pastel: Cámara de Diputados México (2018-2021)**"
...
## Paso 1.1: Empezamos a codificar
...
total_mujeres = sum(d_2018$MUJERES)
total_hombres = sum(d_2018$HOMBRES)
...
ggsave("grafico_2018_hym.png", width = 8, height = 6)
```
...
ggplot(sexo_partido, aes(x = "", y = Porcentaje, fill = Sexo)) +
  ...
  theme_void() +
  labs(title = "Distribución de Mujeres y Hombres por Partido (2018-2021)") +
  theme(
    legend.title = element_blank(),
...
# Guardamos la imagen
ggsave("2018_hym_partidos.png", width = 8, height = 6)
```
